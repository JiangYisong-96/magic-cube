...
__vite_style__.innerHTML = "\n.magic-task-info[data-v-2ac4f56f]{\n	display: flex;\n	flex-direction: column;\n	flex: 1;\n	padding: 5px;\n}\n.magic-task-info form[data-v-2ac4f56f]{\n	display: flex;\n}\n.magic-task-info form label[data-v-2ac4f56f]{\n	display: inline-block;\n	width: 75px;\n	height: 22px;\n	line-height: 22px;\n	font-weight: 400;\n	text-align: right;\n	padding: 0 5px;\n}\n.magic-task-info form[data-v-2ac4f56f] .magic-checkbox{\n	width: 22px;\n	height: 22px;\n}\n.magic-task-info form[data-v-2ac4f56f] .magic-textarea{\n	margin: 5px;\n}\n";
...
var MagicTask = function(vue) {
  ...
  const _withScopeId = (n) => (vue.pushScopeId("data-v-2ac4f56f"), n = n(), vue.popScopeId(), n);
  const _hoisted_1 = { class: "magic-task-info" };
  const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("label", null, "cron", -1));
  const _hoisted_3 = { style: { "flex": "1", "padding-top": "5px" } };
  const _sfc_main = {
  ...
  var MagicTaskInfo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2ac4f56f"]]);
  if (typeof window !== "undefined") {
    let loadSvg = function() {
      var body = document.body;
      var svgDom = document.getElementById("__svg__icons__dom__1659406507858__");
      if (!svgDom) {
        svgDom = document.createElementNS("http://www.w3.org/2000/svg", "svg");
        svgDom.style.position = "absolute";
        svgDom.style.width = "0";
        svgDom.style.height = "0";
        svgDom.id = "__svg__icons__dom__1659406507858__";
