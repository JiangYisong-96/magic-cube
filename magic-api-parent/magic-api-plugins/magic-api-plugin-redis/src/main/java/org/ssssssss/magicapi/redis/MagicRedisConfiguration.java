...
public class MagicRedisConfiguration implements MagicPluginConfiguration {
  ...
  public org.ssssssss.magicapi.core.resource.Resource magicRedisResource(
      RedisConnectionFactory redisConnectionFactory) {
    Resource resource = properties.getResource();
    return new RedisResource(new StringRedisTemplate(redisConnectionFactory), resource.getPrefix(),
        resource.isReadonly());
  }
  ...
  @Cacheable
  public RedisTemplate<String, Object> mgRedisTemplate(
      RedisConnectionFactory redisConnectionFactory) {
